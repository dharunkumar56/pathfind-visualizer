...
function App(){
    ...
    function handleClear(){
        if(finalState() || !checkProcessRunningNew()){
            ...
            document.getElementById(`node-${15}-${55}`).classList.add("end");
        }
        else{
    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <button onClick={handleDijkstras} className="btn btn-primary">Dijkstra's Algorithm</button>
                ...
                <div className="col-lg-4">
                    ...
                    <p>Step2: Select a path finding algorithm</p>
                    <p>Step3: After the algorithm completes execution, press "Clear Board"</p>
                </div>
                <div className="col-lg-4">
                    <p className="new">Start and end node: &nbsp; &nbsp;</p>

                    <div className="example-start new">

                    </div>
                    <br></br>
                    <p className="new">Visited Node: &nbsp; &nbsp;</p>
                    <div className="visited new">

                    </div>
                    <br></br>
                    <p className="new">Node in Path: &nbsp; &nbsp;</p>
                    <div className="example-path new">

                    </div>
                    <br></br>
                    <p className="new">Block Nodes: &nbsp; &nbsp;</p>
                    <div className="example-wall new">
